...
{
    public class GetRestaurantsWithDebtQueryHandler : IRequestHandler<GetRestaurantsWithDebtQuery, PaginatedList<Restaurant>>
    {
        private readonly DatabaseContext _context;
        private readonly IMapper _mapper;

        public GetRestaurantsWithDebtQueryHandler(DatabaseContext context,
                                                  IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<PaginatedList<Restaurant>> Handle(GetRestaurantsWithDebtQuery request, CancellationToken cancellationToken)
        {
